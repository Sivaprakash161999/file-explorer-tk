...
def copyAFile():
    ...
    try:
        ...
        mb.showerror(title='Error!', message="Unable to copy the file. Please try again!")
...
def deleteAFile():
    ...
    try:
        ...
        mb.showerror('WARNING', 'Close the File and try again.')
...
def renameAFile():
    ...
    # create a label
    rename_label = Label(rename_win, text = "Enter the file name:", font=("Calibri", '8'),
                            bg='white', fg='blue')
    ...
    # creating a button
    submitButton = Button(rename_win, text='Submit', command=lambda : NameSubmit(rename_win), width=14, relief=GROOVE,
                        font=('Calibri', '9'), bg='white', fg='blue', activebackground='#709218', activeforeground='#FFFFFF')
    submitButton.pack(pady=2)


# defining a funtion to get the file path
def showFilePath():
    files = fd.askopenfilename(title='Select the file to rename', filetypes=[('All files', "*.*")])
    return files

# defining a funtion that is called when we click on Submit
def NameSubmit(rename_win):
    rename_win.destroy()
...
def moveAFolder():
    ...
    try:
        # using the move() method of shutil module to move the folder to the requested location
...
if __name__ == "__main__":
    ...
    # creating a labe using the Label() widget
    header_label = Label(
    ...
    open_button = Button(
        buttons_frame, text='Open a File', font=('Calibri', '15'), width=20, bg='white',
        fg='blue', relief=GROOVE, activebackground='blue', command=openAFile
    )

    # rename button
    rename_button = Button(
        buttons_frame, text='Rename a File', font=('Calibri', '15'), width=20, bg='white',
        fg='blue', relief=GROOVE, activebackground='blue', command=renameAFile
    )

    # copy button
    copy_button = Button(
        buttons_frame, text='Copy the File', font=('Calibri', '15'), width=20, bg='white',
        fg='blue', relief=GROOVE, activebackground='blue', command=copyAFile
    )

    # delete button
    delete_button = Button(
        buttons_frame, text='Delete the File', font=('Calibri', '15'), width=20, bg='white',
        fg='blue', relief=GROOVE, activebackground='blue', command=deleteAFile
    )

    # open folder button
    open_folder_button = Button(
        buttons_frame, text='Open a Folder', font=('Calibri', '15'), width=20, bg='white',
        fg='blue', relief=GROOVE, activebackground='blue', command=openAFolder
    )

    # delete folder button
    delete_folder_button = Button(
        buttons_frame, text='Delete Folder', font=('Calibri', '15'), width=20, bg='white',
        fg='blue', relief=GROOVE, activebackground='blue', command=deleteAFolder
    )

    # move folder button
    move_folder_button = Button(
        buttons_frame, text='Move the Folder', font=('Calibri', '15'), width=20, bg='white',
        fg='blue', relief=GROOVE, activebackground='blue', command=moveAFolder
    )

    # list all files button
    list_button = Button(
        buttons_frame, text='List files in Folder', font=('Calibri', '15'), width=20, bg='white',
        fg='blue', relief=GROOVE, activebackground='blue', command=listFilesInFolder
    )
    ...
    # main loop of our tkinter window
    win_root.mainloop()
